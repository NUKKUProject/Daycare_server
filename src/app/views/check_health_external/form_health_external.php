    ...
    <div class="student-info mb-3">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="date" name="exam_date" class="form-control dotted-input" required>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mt-2">
                <div class="col-12">
                    ...
                    <input type="text" name="doctor_name" class="form-control dotted-input" placeholder="ชื่อแพทย์/พยาบาล">
                </div>
            </div>
            <div class="row g-3 mt-5">
                <div class="col-6">
                    <label class="form-label fw-bold">ชื่อ-นามสกุล</label>
                    <input type="text" class="form-control dotted-input" value="${student.prefix_th}${student.firstname_th} ${student.lastname_th}">
                </div>
                <div class="col-4">
                    <label class="form-label fw-bold">ชื่อเล่น</label>
                    <input type="text" class="form-control dotted-input" value=" ${student.nickname || '-'}">
                </div>
                <div class="col-2">
                    <label class="form-label fw-bold">ห้องเรียน</label>
                    <input type="text" class="form-control dotted-input" value="${student.classroom}"">     
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="birth_date" class="form-control dotted-input">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label fw-bold">อายุ (ปี)</label>
                        <input type="number" name="age_year" class="form-control dotted-input measurement-input" min="0" max="10">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label fw-bold">เดือน</label>
                        <input type="number" name="age_month" class="form-control dotted-input measurement-input" min="0" max="11">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label fw-bold">วัน</label>
                        <input type="number" name="age_day" class="form-control dotted-input measurement-input" min="0" max="31">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="number" class="form-control measurement-input" step="0.1" name="height" placeholder="120.5" id="height">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="number" name="weight" class="form-control measurement-input" step="0.1" placeholder="25.5" id="weight">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="number" ame="head_circ" class="form-control measurement-input" step="0.1" placeholder="52.0">
                            <span class="input-group-text">เซนติเมตร</span>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="heart_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="liver_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="spleen_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="lymph_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="eyes_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="ears_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="nose_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="respiratory_detail placeholder=" ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="digestive_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="genital_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="dental_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="skin_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="extremities_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <input type="text" class="form-control" name="others_detail" placeholder="ระบุอาการที่พบ..." style="max-width: 30rem;">
                    </div>
                </div>
            </div>
        </div>
